...
use App\Services\Api\AssessmentEditionsService;
use Illuminate\Http\Client\RequestException;

class AssessmentEditionController
{
    protected AssessmentEditionsService $svc;

    public function __construct()
    {
        $this->svc = new AssessmentEditionsService();
    }
