...
use App\Services\Api\ValidationAssessmentSurveysService;
use Illuminate\Http\Client\RequestException;

class ValidationAssessmentSurveyController
{
    protected ValidationAssessmentSurveysService $svc;

    public function __construct()
    {
        $this->svc = new ValidationAssessmentSurveysService();
    }
