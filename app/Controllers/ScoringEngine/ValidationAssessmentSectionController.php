...
use App\Services\Api\ValidationAssessmentSectionsService;
use Illuminate\Http\Client\RequestException;

class ValidationAssessmentSectionController
{
    protected ValidationAssessmentSectionsService $svc;

    public function __construct()
    {
        $this->svc = new ValidationAssessmentSectionsService();
    }
