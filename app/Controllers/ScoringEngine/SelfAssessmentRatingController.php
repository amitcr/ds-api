...
use App\Services\Api\SelfAssessmentRatingsService;
use Illuminate\Http\Client\RequestException;

class SelfAssessmentRatingController
{
    protected SelfAssessmentRatingsService $svc;

    public function __construct()
    {
        $this->svc = new SelfAssessmentRatingsService();
    }
