...
use App\Services\Api\SelfAssessmentSectionsService;
use Illuminate\Http\Client\RequestException;

class SelfAssessmentSectionController
{
    protected SelfAssessmentSectionsService $svc;

    public function __construct()
    {
        $this->svc = new SelfAssessmentSectionsService();
    }
