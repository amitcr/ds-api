...
use App\Services\Api\SelfAssessmentQuestionsService;
use Illuminate\Http\Client\RequestException;

class SelfAssessmentQuestionController
{
    protected SelfAssessmentQuestionsService $svc;

    public function __construct()
    {
        $this->svc = new SelfAssessmentQuestionsService();
    }
