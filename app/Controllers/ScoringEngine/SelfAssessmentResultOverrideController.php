...
use App\Services\Api\SelfAssessmentResultOverridesService;
use Illuminate\Http\Client\RequestException;

class SelfAssessmentResultOverrideController
{
    protected SelfAssessmentResultOverridesService $svc;

    public function __construct()
    {
        $this->svc = new SelfAssessmentResultOverridesService();
    }
