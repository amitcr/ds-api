...
use App\Services\Api\SelfAssessmentGradersService;
use Illuminate\Http\Client\RequestException;

class SelfAssessmentGraderController
{
    protected SelfAssessmentGradersService $svc;

    public function __construct()
    {
        $this->svc = new SelfAssessmentGradersService();
    }
