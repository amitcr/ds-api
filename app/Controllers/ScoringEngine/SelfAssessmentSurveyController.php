...
use App\Services\Api\SelfAssessmentSurveysService;
use Illuminate\Http\Client\RequestException;

class SelfAssessmentSurveyController
{
    protected SelfAssessmentSurveysService $svc;

    public function __construct()
    {
        $this->svc = new SelfAssessmentSurveysService();
    }
