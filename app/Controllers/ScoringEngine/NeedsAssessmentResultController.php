...
use App\Services\Api\NeedsAssessmentResultsService;
use Illuminate\Http\Client\RequestException;

class NeedsAssessmentResultController
{
    protected NeedsAssessmentResultsService $svc;

    public function __construct()
    {
        $this->svc = new NeedsAssessmentResultsService();
    }
