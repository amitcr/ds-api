...
<!--page1 starts here-->
<!--page1 starts here-->
<div class="page" style="height:1060px;float:left;width:100%;padding-left:0px;margin-left:0px; ">
	<table style="width: 100%; display:inline-block;">
		...
		<tr>
			<td>
				<table style="width: 100%; display:inline-block;" align="center">
					<tr style="width: 100%; display:inline-block;">
						<td align="center" style="width:41.2px;border: 2px solid #494949; padding:3px;padding-top:2px;">
							<?php if($Top_one == "D"){ ?>
								<div class="text-center" style="color:#633319;font-size: 36px;position:relative; top:0px; display: block; left:-25.8px;  width:100%;background-color: #f26868; ">
									<h4 class="text-center" style="color:#992253;font-size: 33px;position:relative; top:1px;width:100%;background-color: #f26868; padding:0px; margin:6px 0px;height:69px; ">D</h4> 
								</div>
							<?php }else if($Top_one == "I"){ ?>
								<div class="text-center" style="color:#633319;font-size: 35px;position:relative; top:0px; display: block; left:-25.8px;  width:100%;background-color: #feec86; ">
									<h4 class="text-center" style="color:#582612;font-size: 33px;position:relative; top:1px;width:100%;background-color: #feec86; padding:0px; margin:6px 0px;height:70px; ">I</h4> 
								</div>
							<?php }else if($Top_one == "S"){ ?>
								<div class="text-center" style="color:#E8F2FD;font-size: 35px;position:relative; top:0px; display: block; left:-25.8px;  width:100%;background-color: #ADD1DE; ">
									<h4 class="text-center" style="color:#E8F2FD;font-size: 33px;position:relative; top:1px;width:100%;background-color: #ADD1DE; padding:0px; margin:6px 0px;height:70px; ">S</h4> 
								</div>
							<?php }else if($Top_one == "C"){ ?>
								<div class="text-center" style="color:#E8F2FD;font-size: 35px;position:relative; top:0px; display: block; left:-25.8px;  width:100%;background-color: #65BE4B; ">
									<h4 class="text-center" style="color:#E8F2FD;font-size: 33px;position:relative; top:1px;width:100%;background-color: #65BE4B; padding:0px; margin:6px 0px;height:70px; ">C</h4> 
								</div>
							<?php } ?>
						</td>
						<td align="center" style="width:10px;"> </td>
						<td align="center" style="width:41.2px; height:0px;border: 2px solid #494949; padding:3px; padding-top:2px;padding-bottom:1px;">
							<?php if($Top_two == "D"){ ?>
								<div class="text-center" style="color:#633319;font-size: 36px;position:relative; top:0px; display: block; left:-25.8px;  width:100%;background-color: #f26868; ">
									<h4 class="text-center" style="color:#992253;font-size: 33px;position:relative; top:1px;width:100%;background-color: #f26868; padding:0px; margin:6px 0px;height:69px; ">D</h4> 
								</div>
		...
		<tr style="width: 100%; display:inline-block;">
			<td align="center" style="width: 100%; display:inline-block; padding-top:200px;"> 
				<img style="width: 250px; text-align:center; " src="<?=MYTEMPERAMENT_PLUGIN_DIR?>templates/report/images/disc-logo.jpg"> 
...
<!--page1 ends here-->
<!--page2 starts here-->
<div class="page" style="float:left;width:1000px;padding-left:0px;margin-left:0px;">
	<table style="width: 100% margin-left:38px;margin-right:40px;">
		<tr style="margin-bottom:0px;">
			<td align="center" style="margin-bottom:0px;">
				<h1 class="text-center" style="font-size: 25pt;margin-bottom: 5px; padding-top:20px; line-height:25pt;">HOW TO ENGAGE, COACH, AND LEAD<br><?=strtoupper($participantName)?></h1> 
				...
				<table style="width: 100%; display:inline-block;margin-top:0px;">
					<tr style="margin-top:0px;">
						<td align="center" style="width: 100%; display:inline-block;margin-top:0px;">
							<h3 style="font-size: 20pt;margin-bottom: 0px; padding-top:0px; margin-top:0px; line-height:20pt;"><?=$particiapnt_first_name?>'s temperament combination</h3>
						</td>
					</tr>
					<tr>
						<td style="margin-bottom:0px;margin-top:0px;">
							<table style="width: 100%; display:inline-block;" align="center">
								<tr style="width: 100%; display:inline-block;">
									<td align="center" style="width:18px;border: 2px solid #494949; padding:3px; padding-top:3px;">
										<?php if($Top_one == "D"){ ?>
											<div class="text-center" style="color:#633319;font-size: 20px; height:18px; position:relative; top:0px; display: block; left:-14px;  width:100%;background-color: #f26868; ">
												<h4 class="text-center" style="color:#992253;font-size: 15px;position:relative; top:1px;width:100%;background-color: #f26868; padding:0px; margin:2px 0px;height:18px; ">D</h4> 
											</div>
										<?php }else if($Top_one == "I"){ ?>
											<div class="text-center" style="color:#633319;font-size: 20px; height:18px; position:relative; top:0px; display: block; left:-14px;  width:100%;background-color: #feec86; ">
												<h4 class="text-center" style="color:#582612;font-size: 15px;position:relative; top:1px;width:100%;background-color: #feec86; padding:0px; margin:2px 0px;height:18px; ">I</h4> 
											</div>
										<?php }else if($Top_one == "S"){ ?>
											<div class="text-center" style="color:#E8F2FD;font-size: 20px; height:18px; position:relative; top:0px; display: block; left:-14px;  width:100%;background-color: #ADD1DE; ">
												<h4 class="text-center" style="color:#E8F2FD;font-size: 15px;position:relative; top:1px;width:100%;background-color: #ADD1DE; padding:0px; margin:2px 0px;height:18px; ">S</h4> 
											</div>
										<?php }else if($Top_one == "C"){ ?>
											<div class="text-center" style="color:#E8F2FD;font-size: 20px; height:18px; position:relative; top:0px; display: block; left:-14px;  width:100%;background-color: #65BE4B; ">
												<h4 class="text-center" style="color:#E8F2FD;font-size: 15px;position:relative; top:1px;width:100%;background-color: #65BE4B; padding:0px; margin:2px 0px;height:18px; ">C</h4> 
											</div>
										<?php } ?>
									</td>
									<td align="center" style="width:10px;"> </td>
					...
					<tr style="width: 100%; display:inline-block;margin-top:0px;">
						<td align="center" style="width: 100%; display:inline-block;margin-top:0px;">
							<h3 style="font-size: 20pt;margin-top:0px;margin-bottom: 5px; padding-top:5px; line-height:20pt;">is known as <?=strtoupper($the_report_pattern)?></h3>
						</td>
					</tr>
				</table>
		...
		<?php }else if($Top_one == "D" && $Top_two == "C"){ ?>
			...
			<tr>
				<td align="center">
					<h3 style="font-size: 20pt;margin-bottom: 5px; margin-top:5px; line-height:20pt;">QUICK REFERENCE GUIDE WHEN ENGAGING<br/><?=strtoupper($participantName)?></h3>
				</td>
			</tr>
	...
	<table style="width: 100% margin-left:38px;margin-right:40px;">
		...
		<tr>
			<td align="left">
				...
				<p style="color: #555655;font-family: 'proxima_novaregular';font-size: 12pt;line-height: 18px;margin:0px; margin-bottom:15px;padding:0px 15px">Always be thinking, how can I better meet <?=$particiapnt_first_name?>’s needs on an ongoing basis.</p>
